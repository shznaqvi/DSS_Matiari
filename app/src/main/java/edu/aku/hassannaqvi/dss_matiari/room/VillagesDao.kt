...
interface VillagesDao {
    ...
    @Query(
        "SELECT " + TableContracts.TableVillage.COLUMN_VILLAGE_NAME + "," + TableContracts.TableVillage.COLUMN_VILLAGE_CODE
    ...
    @Query(
        "SELECT DISTINCT " + TableContracts.TableVillage.COLUMN_UCNAME + ","
